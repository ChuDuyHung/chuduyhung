...
public function show_brand_index($cartegory_id,$brand_id){
    // $query = "SELECT * FROM tbl_brand ORDER BY brand_id DESC ";
    $query = "SELECT * FROM tbl_cartegory,tbl_brand WHERE tbl_cartegory.cartegory_id = tbl_brand.cartegory_id AND 
    tblbrand.cartegory_id = '$_GET[id]' ORDER BY tbl_brand.brand_id DESC ";
     $result = $this -> db -> select($query);
     return $result;
